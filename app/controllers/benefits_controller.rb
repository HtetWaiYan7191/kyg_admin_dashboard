class BenefitsController < ApplicationController
  ...
  before_action :set_brand_partner 
  ...
  private
    ...
    def set_brand_partner
      @brand_partner = BrandPartner.includes(:benefits).find(params[:brand_partner_id])
    end

    # Only allow a list of trusted parameters through.
    def benefit_params
      params.require(:brand_partner).permit(:content, :remark).merge(brand_partner_id: @brand_partner.id)
    end
end
