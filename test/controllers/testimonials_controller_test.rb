...
class TestimonialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create testimonial" do
    assert_difference("Testimonial.count") do
      post testimonials_url, params: { testimonial: { name: @testimonial.name, speech: @testimonial.speech } }
    end
  ...
  test "should update testimonial" do
    patch testimonial_url(@testimonial), params: { testimonial: { name: @testimonial.name, speech: @testimonial.speech } }
